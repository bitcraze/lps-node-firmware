...
INCLUDES=-Iinc -Iinc/f0 -Iinc/l4 -I./hal/stm32f0xx/Inc -I./hal/stm32l4xx/Inc \
		 ...
		 -IMiddlewares/ST/STM32_USB_Device_Library/Core/Inc -Icubemx/Core/Inc
...
OBJS+=src/startup_stm32f072_stm32l422.o src/l4/system_stm32l4xx.o
OBJS+=src/stm32f0xx_stm32l4xx_it.o src/l4/stm32l4xx_hal_msp.o
...
CFLAGS+=$(PROCESSOR) $(INCLUDES) -O3 -g3 -Wall -Wno-pointer-sign -std=gnu11 -DL4_ENABLED=0
